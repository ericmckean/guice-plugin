...
public class CodeLocationsResultsTest extends TestCase {
    ...
    public void testValidLocationNodeTree() {
        ...
        assertTrue(results.getRoot().toString().equals(expectedResultForValidLocation().toString()));
    }
    ...
    public void testBrokenAndValidLocationsNodeTree() {
        ...
        assertTrue(results.getRoot().toString().equals(expectedResultForBothLocations().toString()));
        assertFalse(results.getRoot().toString().equals(expectedResultForValidLocation().toString()));
    }
