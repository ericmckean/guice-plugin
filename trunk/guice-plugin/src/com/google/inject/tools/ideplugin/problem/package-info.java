...
/**
 * Classes for representing and handling guice related problems in the user's
 * code.
 * 
 * <p>
 ...
 * {@link com.google.inject.tools.ideplugin.problem.ProblemsListener} (more
 * accurately its IDE specific implementations) listen for changes in the user's
 * code and check it for problems, then notifying the handler.
 * 
 * <p>
