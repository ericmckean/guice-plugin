...
/**
 * A CodeSnippet is a piece of code to be executed by the {@link com.google.inject.tools.ideplugin.code.CodeRunner} in user space.
 * Any code we wish to execute in userspace must extend this and be in the snippets package.
 * A snippet *must* implement the main method as that is what the CodeRunner will run.
 * The main method should print the {@link com.google.inject.tools.ideplugin.snippets.CodeSnippetResult} for itself to System.out.
 * 
