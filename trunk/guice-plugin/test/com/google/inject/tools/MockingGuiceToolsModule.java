...
public class MockingGuiceToolsModule extends GuiceToolsModule {
  ...
  public MockingGuiceToolsModule useProblemsHandler(
  ...
  public static class ProxyException extends RuntimeException {
    ...
    public String toString() {
      return "Proxy exception: method " + method.toString()
          + " called on proxy " + proxy.toString();
    }
  }
  ...
  public static class ModuleManagerInstanceFactory implements
  ...
  public static class ModuleManagerMockFactory extends
      ModuleManagerInstanceFactory {
    @Inject
